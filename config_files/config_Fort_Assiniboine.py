...
output_file_name_fluxes = '/Users/peterlafollette/Desktop/alt-modular/Modules/GAR/LGAR_BMI/outputs/output_Fort_Assiniboine.pkl'

###this is the path of the directory that contains the forcing data
forcing_data_folder = '~/desktop/alt-modular/Modules/GAR/LGAR_BMI/forcing_data_files/Fort_Assiniboine/'
...
params_file = '/Users/peterlafollette/Desktop/alt-modular/Modules/GAR/LGAR_BMI/parameter_files/params_Fort_Assiniboine.py'

###this is the path and name of the file the reformats raw forcing data
forcing_data_formatter_file = '/Users/peterlafollette/Desktop/alt-modular/Modules/GAR/LGAR_BMI/forcing_data_files/Fort_Assiniboine/forcing_data_formatter_Fort_Assiniboine.py'
#######

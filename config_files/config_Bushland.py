...
import os, sys
output_path_and_name = 'outputs/output_Bushland.pkl'
params_file_path_and_name = 'parameter_files/params_Bushland.py'
forcing_data_file_path_and_name = 'forcing_data_files/Bushland/forcing_data_resampled_Bushland.csv'

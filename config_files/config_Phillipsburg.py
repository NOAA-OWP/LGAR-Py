...
import os, sys
output_path_and_name = 'outputs/output_Phillipsburg.pkl'
params_file_path_and_name = 'parameter_files/params_Phillipsburg.py'
forcing_data_file_path_and_name = 'forcing_data_files/Phillipsburg/forcing_data_resampled_Phillipsburg.csv'

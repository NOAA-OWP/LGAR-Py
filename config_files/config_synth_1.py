...
length_of_simulation = 144#12#67#144 #This is the length of the simulation, in time steps. Default for Panama is 68910.
...
output_file_name_fluxes = '/Users/peterlafollette/Desktop/alt-modular/Modules/GAR/LGAR_BMI/outputs/output_synth_1.pkl'

###this is the path of the directory that contains the forcing data
forcing_data_folder = '~/desktop/alt-modular/Modules/GAR/LGAR_BMI/forcing_data_files/synth_1/'
#forcing_data_folder = '~/desktop/alt-modular/Modules/GAR/LGARTO_BMI/forcing_data_files/synth_1/'

###this is the name of the raw, unformatted forcing data file
raw_forcing_data_file_name = 'forcing_data_synth_1_raw.csv'

###this is the name of the resampled, correctly formatted forcing data file that is output by the forcing data reformatter
formatted_forcing_data_name = 'forcing_data_resampled_synth_1.csv'

###this is the path and name of the parameters file
params_file = '/Users/peterlafollette/Desktop/alt-modular/Modules/GAR/LGAR_BMI/parameter_files/params_synth_1.py'
#params_file = '/Users/peterlafollette/Desktop/alt-modular/Modules/GAR/LGARTO_BMI/parameter_files/params_synth_1.py'

###this is the path and name of the file the reformats raw forcing data
forcing_data_formatter_file = '/Users/peterlafollette/Desktop/alt-modular/Modules/GAR/LGAR_BMI/forcing_data_files/synth_1/forcing_data_formatter_synth_1.py'
#forcing_data_formatter_file = '/Users/peterlafollette/Desktop/alt-modular/Modules/GAR/LGARTO_BMI/forcing_data_files/synth_1/forcing_data_formatter_synth_1.py'

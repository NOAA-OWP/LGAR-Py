...
import os, sys
output_path_and_name = 'outputs/output_synth_3.pkl'
params_file_path_and_name = 'parameter_files/params_synth_3.py'
forcing_data_file_path_and_name = 'forcing_data_files/synth_3/forcing_data_resampled_synth_3.csv'

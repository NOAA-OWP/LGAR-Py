...
formatted_forcing_data_name = 'forcing_data_resampled_uniform_Fort_Assiniboine.csv' #this will be the name of the output forcing data, in the correct format for LGAR-Py.

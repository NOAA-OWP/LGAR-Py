...
forcing_data_folder = '~/desktop/LGAR-py/forcing_data_files/Bushland/' #This is the location of both the raw and reformatted forcing datasets.
raw_forcing_data_file_name = 'forcing_data_Bushland_raw.csv' #This is the input (raw) USDA SCAN forcing dataset.
formatted_forcing_data_name = 'forcing_data_resampled_uniform_Bushland.csv' #this will be the name of the output forcing data, in the correct format for LGAR-Py.

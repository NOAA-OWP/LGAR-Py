...
theta_r_layer_0          = 0.0648  #residual volumetric water content.            unitless
theta_s_layer_0          = 0.4513   #total porosity.                               unitless
K_s_layer_0              = 4.5   #saturated hydraulic conductivity.             mm/h
###fine-coarse-fine testing
#K_s_layer_0              = 1.04   #saturated hydraulic conductivity.             mm/h
alpha_layer_0            = 0.00031297 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_0                = 1.6858   #unitless
m_layer_0                = 1-1/n_layer_0   #unitless
max_depth_layer_0        = 440 #100   #mm, this is the thickness of the first soil layer
...
theta_r_layer_1         = 0.0831  #residual volumetric water content.            unitless
theta_s_layer_1         = 0.4773   #total porosity.                               unitless
K_s_layer_1             = 0.7    #saturated hydraulic conductivity.             mm/h
alpha_layer_1           = 0.00083272 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_1               = 1.299   #unitless
m_layer_1               = 1-1/n_layer_1   #unitless
max_depth_layer_1       = 1310    #mm
#note that alpha, n, and m are van Genuchten parameters
...
theta_r_layer_2         = 0.0668  #residual volumetric water content.            unitless
theta_s_layer_2         = 0.4617   #total porosity.                               unitless
K_s_layer_2             = 4.5    #saturated hydraulic conductivity.             mm/h
alpha_layer_2           = 0.00037454 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_2               = 1.6151   #unitless
m_layer_2               = 1-1/n_layer_2   #unitless
max_depth_layer_2       = 250 #10000   #mm
#note that alpha, n, and m are van Genuchten parameters

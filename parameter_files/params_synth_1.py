...
theta_r_layer_0          = 0.078  #residual volumetric water content.            unitless
theta_s_layer_0          = 0.43#43   #total porosity.                               unitless
K_s_layer_0              = 10.4*3   #saturated hydraulic conductivity.             mm/h
###fine-coarse-fine testing
#K_s_layer_0              = 1.04   #saturated hydraulic conductivity.             mm/h
alpha_layer_0            = 0.0036 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_0                = 1.56   #unitless
...
theta_r_layer_1         = 0.095  #residual volumetric water content.            unitless
theta_s_layer_1         = 0.41   #total porosity.                               unitless
K_s_layer_1             = 2.6    #saturated hydraulic conductivity.             mm/h
alpha_layer_1           = 0.0019 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_1               = 1.31   #unitless
...
#third layer: silty clay loam (finer than layer above) (HYDRUS catalog)
theta_r_layer_2         = 0.089  #residual volumetric water content.            unitless
theta_s_layer_2         = 0.43 #43  #total porosity.                               unitless
K_s_layer_2             = 0.7    #saturated hydraulic conductivity.             mm/h
alpha_layer_2           = 0.0010 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_2               = 1.23   #unitless

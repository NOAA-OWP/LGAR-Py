...
#first layer: silty clay loam (SCAN)
theta_r_layer_0          = 0.0649  #residual volumetric water content.            unitless
theta_s_layer_0          = 0.4481   #total porosity.                               unitless
K_s_layer_0              = 0.7   #saturated hydraulic conductivity.             mm/h
###fine-coarse-fine testing
#K_s_layer_0              = 1.04   #saturated hydraulic conductivity.             mm/h
alpha_layer_0            = 0.0009567 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_0                = 1.379   #unitless
m_layer_0                = 1-1/n_layer_0   #unitless
max_depth_layer_0        = 180 #100   #mm, this is the thickness of the first soil layer
...
#second layer: silty clay (SCAN)
theta_r_layer_1         = 0.0672  #residual volumetric water content.            unitless
theta_s_layer_1         = 0.4760   #total porosity.                               unitless
K_s_layer_1             = 0.2    #saturated hydraulic conductivity.             mm/h
alpha_layer_1           = 0.0005288 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_1               = 1.5276   #unitless
m_layer_1               = 1-1/n_layer_1   #unitless
max_depth_layer_1       = 760    #mm
#note that alpha, n, and m are van Genuchten parameters
param_set_1 = [theta_r_layer_1, theta_s_layer_1, K_s_layer_1, alpha_layer_1, n_layer_1, m_layer_1, max_depth_layer_1]


#third layer: clay (SCAN)
theta_r_layer_2         = 0.0823  #residual volumetric water content.            unitless
theta_s_layer_2         = 0.4782   #total porosity.                               unitless
K_s_layer_2             = 2      #saturated hydraulic conductivity.             mm/h
alpha_layer_2           = 0.0004467 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_2               = 1.4585   #unitless
m_layer_2               = 1-1/n_layer_2   #unitless
max_depth_layer_2       = 1350 #10000   #mm
#note that alpha, n, and m are van Genuchten parameters

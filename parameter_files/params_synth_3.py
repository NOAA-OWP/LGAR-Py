...
##first layer: loamy sand (HYDRUS catalog)
theta_r_layer_0          = 0.057  #residual volumetric water content.            unitless
theta_s_layer_0          = 0.41#43   #total porosity.                               unitless
K_s_layer_0              = 145.9164  #saturated hydraulic conductivity.             mm/h
###fine-coarse-fine testing
#K_s_layer_0              = 1.04   #saturated hydraulic conductivity.             mm/h
alpha_layer_0            = 0.0124 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_0                = 2.28   #unitless
...
#second layer: loam (HYDRUS catalog)
theta_r_layer_1         = 0.078  #residual volumetric water content.            unitless
theta_s_layer_1         = 0.43   #total porosity.                               unitless
K_s_layer_1             = 10.4    #saturated hydraulic conductivity.             mm/h
alpha_layer_1           = 0.0036 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_1               = 1.56   #unitless
...
#third layer: silt loam (HYDRUS catalog)
theta_r_layer_2         = 0.067  #residual volumetric water content.            unitless
theta_s_layer_2         = 0.45 #43  #total porosity.                               unitless
K_s_layer_2             = 4.5      #saturated hydraulic conductivity.             mm/h
alpha_layer_2           = 0.002 #keep in mind the unit here is mm^-1, often alpha is reported in cm^-1
n_layer_2               = 1.41   #unitless
